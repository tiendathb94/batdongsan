...
class Form extends Component {
    ...
    componentDidMount = () => {
        ...
        if(this.state.formValues){
            this.getPriceUnit(this.state.formValues.category.slug)
        }    
        this.setTotalPrice();
    }
    ...
    onSubmitData = async () => {
        var today = new Date();
        var date_upload_file = today.getFullYear() + '-' + today.getMonth() + '-' + today.getDate();
        ...
        try {
            ...
            // Create project
            const response = await axios.put(`${config.api.baseUrl}/posts/${formValues.id}`, formValues);

            await formValues.image_libraries.map((tab) => {
                this.deleteUploadedLibraries(tab)
                this.doUpload(
                    'App\\Entities\\Post',
                    formValues.id,
                    'post',
                ...
                <div>
                    ...
                    <div className="row">
                        <div className="col col-sm-12">
                            ...
                            <input type="text" onChange={this.onChange} className="form-control" id="title" name="title" value={this.state.formValues.title || ''}/>
                    ...
                    <div className="row">
                        <div className="col col-sm-12 col-md-6">
                            ...
                            <select onChange={this.onChange} className="form-control" id="form" name="slugParent" value={this.state.formValues.category.slug}>
                        ...
                        <div className="col col-sm-12 col-md-6">
                            <CategoryField
                                ...
                                slugParent={this.state.formValues.category.slug}
                                onChange={this.onChange}
                                message={this.state.errorByFields.category_id}
                                value={this.state.formValues.category_id}
                            />
                        </div>
                    </div>
                    <AddressForm
                    ...
                    <div className="row">
                        <div className="col col-sm-12 col-md-6">
                            ...
                            <AutocompleteField
                                ...
                                placeholder="-- Dự án --"
                                selectedItem={
                                    this.state.formValues && this.state.formValues.project ? {
                                        value: this.state.formValues.project.id,
                                        name: this.state.formValues.project.long_name
                                    } : {}
                                }
                            />
                        </div>
                        <div className="col col-sm-12 col-md-6">
                            ...
                            <div className="w-75 d-flex align-items-center">
                                <input type="text" onChange={this.onChange} ref={this.totalAreaField} className="form-control mr-3" name="total_area" value={this.state.formValues.total_area}/>
                                <span>m2</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        <div className="col col-sm-12 col-md-6">
                            ...
                            <input onChange={this.onChange} ref={this.priceField}  type="number" className="form-control mr-3" name="price" value={this.state.formValues.price}/>
                        </div>
                        <div className="col col-sm-12 col-md-6">
                            <label htmlFor="">Đơn vị</label>
                            <select onChange={this.onChange} ref={this.priceUnitField} name="price_unit" id="" className="form-control" value={this.state.formValues.price_unit}>
                    ...
                    <div className="row">
                        <div className="col">
                            ...
                            <Editor
                                editorState={EditorState.createWithContent(stateFromHTML(this.state.formValues.content))}
                    ...
                    <div className="row mt-3">
                        <div className="col">
                            ...
                            <ImageLibraryUpload ref={this.imageLibraryUpload} uploadedImages={
                                this.state.formValues.image_libraries
                            }/>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        <div className="col col-sm-12 col-md-6">
                            ...
                            <input onChange={this.onChange} type="text" className="form-control" id="" name="facade" value={this.state.formValues.facade}/>
                        </div>
                        <div className="col col-sm-12 col-md-6">
                            <label htmlFor="">Đường vào (m)</label>
                            <input onChange={this.onChange} type="text" className="form-control" id="" name="way_in" value={this.state.formValues.way_in}/>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        <div className="col col-sm-12 col-md-6">
                            ...
                            <select onChange={this.onChange} className="form-control" id="" name="direction_house" defaultValue={this.state.formValues.direction_house}>
                                {
                        ...
                        <div className="col col-sm-12 col-md-6">
                            ...
                            <select onChange={this.onChange} className="form-control" id="" name="direction_balcony" defaultValue={this.state.formValues.direction_balcony}>
                                {
                                    this.state.direction.map((value, key) => (<option key={key} value={key}>{value}</option>))
                                }
                            </select>
                    ...
                    <div className="row">
                        <div className="col col-sm-12 col-md-6">
                            ...
                            <input type="number" onChange={this.onChange} className="form-control" id="" name="number_of_floors" value={this.state.formValues.number_of_floors}/>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        <div className="col col-sm-12 col-md-6">
                            ...
                            <input type="number" onChange={this.onChange} className="form-control" id="" name="number_of_bedroom" value={this.state.formValues.number_of_bedroom}/>
                        </div>
                        <div className="col col-sm-12 col-md-6">
                            <label htmlFor="">Số toilet</label>
                            <input type="number" onChange={this.onChange} className="form-control" id="" name="number_of_toilet" value={this.state.formValues.number_of_toilet}/>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        <div className="col">
                            ...
                            <textarea onChange={this.onChange} name="furniture" className="form-control" id="" rows="3" defaultValue={this.state.formValues.furniture}>
                            </textarea>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        <div className="col">
                            ...
                            <textarea onChange={this.onChange} className="form-control" placeholder="Ví dụ: đã có sổ đỏ, sổ hồng,..." name="legal_information" id="" rows="3" defaultValue={this.state.formValues.legal_information}>
                    ...
                    <div className="row mt-3">
                        <div className="col d-flex justify-content-center">
                            <button type="button" onClick={this.onSubmitData} className="btn btn-success mr-3">Cập nhật tin</button>
                        </div>
                    </div>
                </div>
            )
