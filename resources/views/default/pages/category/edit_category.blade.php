...
<h3 style="margin-bottom: 20px">Cập nhật danh mục</h3>
    <div class="container main">
        ...
        <form action="{{ route('pages.category.update',['id' => $category->id]) }}" method="POST" class="row" enctype="multipart/form-data">
            @csrf
            <div class="col-sm-12">
                <div class="form-group">
                    <label for="name">Tên danh mục</label>
                    <input type="text" name="name" value="{{$category->name}}" class="form-control" id="name" placeholder="Tên danh mục">
                </div>
                <div class="form-group">
                    <label for="slug">Slug danh mục</label>
                    <input type="text" name="slug" value="{{$category->slug}}" class="form-control" id="slug" placeholder="Slug danh mục">
                </div>
                <div class="form-group">
                ...
                @if($category->parent_id != null OR $category->parent_id != 0)
                <div class="form-group">
