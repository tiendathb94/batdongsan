            ...
            <div class="col-sm-12">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="col-sm-12">
                            <input type="checkbox" id="check1" name="feature_news" value="0">
                            <label for="feature_news"> {{trans('lang.feature_news')}}</label><br>
                            <input type="checkbox" id="check2" name="advice" value="0">
                            <label for="advice"> {{trans('lang.advice')}}</label><br>
                            <input type="checkbox" id="check3" name="feng_shui" value="0">
