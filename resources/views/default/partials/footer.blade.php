...
<footer>
   <div class="home-small">
         ...
         <div class="footer-col2">
            <div class="footer-sub-col1">
               ...
               <div class="col-content">
                  <ul>
                     <li><a href="#" rel="nofollow">Báo giá &amp; hỗ trợ</a></li>
                     <li><a href="#" rel="nofollow">Câu hỏi thường gặp</a></li>
                     <li><a href="#" rel="nofollow">Về chúng tôi</a></li>
                     <li><a href="#" rel="nofollow">Thông báo</a></li>
            ...
            <div class="footer-sub-col2">
               ...
               <div class="col-content">
                  <ul>
                     <li><a href="#" rel="nofollow">Quy định đăng tin</a></li>
                     <li><a href="#" rel="nofollow">Quy chế hoạt động</a></li>
                     <li><a href="#" rel="nofollow">Điều khoản thỏa thuận</a></li>
                     <li><a href="#" rel="nofollow">Chính sách bảo mật</a></li>
                     <li><a href="#" rel="nofollow">Giải quyết khiếu nại</a></li>
                     <li><a href="#" target="_blank" rel="nofollow">Góp ý báo lỗi</a></li>
                  </ul>
               </div>
            </div>
            ...
            <div class="footer-sub-col4">
               ...
               <div class="col-content">
                  <div class="list-international">
                     ...
                     <div class="national">
                        <div class="vietnam">
                           <img src="/images/icons/vietnam.png">
                           Việt Nam
                        </div>
                        <!-- <ul id="country">
                           <li>
                              <a target="_blank" href="http://www.rumah.com/" title="Indonesia Real Estate">
                              <img src="/images/icons/indonesia.png" alt="Indonesia Real Estate">Indonesia
                              </a>
                           </li>
                        </ul> -->
                     </div>
                  ...
                  <div class="language">
                     Chọn ngôn ngữ&nbsp;&nbsp;<a href="#">
                     <img src="/images/icons/eu.png">
                     En
                     </a>
                  </div>
               </div>
      ...
      <div class="footer-row list-branch">
         <div class="branch-show">Xem tất cả chi nhánh của Batdongsan.com.vn&nbsp;&nbsp;<img src="/images/icons/down-arrow-grey.png" class="downarr"><img src="/images/icons/up-arrow.png" class="uparr hidden"></div>
         <div class="branch-detail">
            <div class="branch-col">
               ...
               <div class="branch">
                  ...
                  <div class="branch-add">
                     Tầng 9, tòa nhà Vĩnh Trung Plaza, số 255 – 257 Hùng Vương, phường Vĩnh Trung, quận Thanh Khê, TP. Đà Nẵng<br>
